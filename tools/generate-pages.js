...
.disclosure{font-size:.72rem;color:var(--gray-3);font-style:italic;margin-top:1.25rem}
...
<p class="disclosure">Como Afiliado de Amazon, ${BRAND_NAME} obtiene ingresos por las compras adscritas que cumplen los requisitos aplicables. Los precios son orientativos y pueden variar.</p>
</footer>
</body>
</html>`;
}
